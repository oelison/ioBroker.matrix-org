...
*/
helper.getBasenameFromFilePathOrUr = function(file)
{
    if (file.match(/^\w+:\/\//))
    {
        try
 ...
 * @param {object} base64Object The possibly bas64 encoded data string.
 * @returns Object of `buffer` and `name` from the base64 string or null if no base64 string.
 */
helper.getBufferAndNameFromBase64Object = function(base64Object)
{
 ...
 * @returns Object of `buffer` and `name` from the base64 string or null if no base64 string.
 */
helper.getBufferAndNameFromBase64String = function(base64String)
{
 ...
 */
helper.getFileTypeFromData = function(buffer)
{
    let imageType = "";
    if (buffer.length > 4)
    {
